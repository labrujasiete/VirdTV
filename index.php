...
<title>Vird</title>
<link rel="stylesheet" type="text/css" href="bird_style.css">
...
<body>
	...
	<div class="side_menu" id="side_menu">
		...
		<a href="index.php" class="a_sm a_sm_selected">Peliculas</a>
	...
	<div class="wrapper" id="wrapper">
		...
		<!--
		<div class="movie_container_div">
			<a class="movie_container_a" href="#">
				<div class="categorie_tag"><div class="half_sqr"></div>Action</div>
				<div class="star_div"><img class="star_img" src="assets/icons/star.svg"><p class="raiting_p">6.8</p></div>
				<div class="movie_cover" style="background-image: url('assets/covers/007spectre.jpg')"></div>
				<p class="small_info">(2015) ESP-ENG</p>
				<p class="title">007 Spectre</p>
			</a>
		</div>
		-->
